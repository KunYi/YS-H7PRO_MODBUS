...
#define BUILD_strYEAR __DATE__[ 7]__DATE__[8]__DATE__[9]__DATE__[10]
#define BUILD_strMONTH ((BUILD_DATE_IS_BAD) ? "99" : COMPUTE_BUILD_strMONTH)
#define BUILD_strDAY  __DATE__[4]__DATE__[5]
#endif // BUILD_DEFS_H
